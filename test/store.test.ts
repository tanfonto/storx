...
test.cb('dispatching bound action updates state accordingly', t => {
...
// test.cb(
//   'complex state gets updated according to the rules specified by a bound reducer',
//   t => {
//     const store = Store(
//       { value: 1 },
//       {
...
// test.cb(
//   'primitive state gets updated according to the rules specified by a free reducer',
//   t => {
...
// test.cb(
//   'complex state gets updated according to the rules specified by a free reducer',
//   t => {
...
//   store()
//     .pipe(skip(2), map(s => t.deepEqual(s, { value: 70 })))
//     .subscribe(t.end);
